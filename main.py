''' gõ ở terminal để cài đặt các gói
        ...
        if is_medical_issue(user_prompt):
            ...
            with st.chat_message(
                ...
                if "chào" in user_prompt.lower():
                    st.markdown(f"chào {user_name}. I'm Gemini Chatbot, I will help you answer questions about the medical field")
                elif "bạn là ai" in user_prompt.lower():
                    st.markdown("I am a Gemini Secretary dedicated to answering medical questions.")
                else:
